...
| 函数指针          | 作用                               | 调用时机                   | 适用访问类型           |
| :---------------- | :--------------------------------- | :------------------------- | :--------------------- |
| read\_first\_record | 定位并读取**第一条**符合条件的记录 | 循环**开始前**调用1次      | 所有类型               |
| read\_record       | 读取**下一条**符合条件的记录       | 循环中反复调用，直到返回-1 | ref, range, index, ALL |
...
* http://www.iskm.org/mysql56/sql\_\_executor\_8cc\_source.html
